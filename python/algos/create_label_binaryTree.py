    ...
    while to_visit:
        ...
        for child in binarytreeG[parent]:
            if child not in labels:
                ...
                labels[child] = {child: 0, parent:binarytreeG[parent][child]}
                for p_label in labels[parent]:
                    if p_label not in labels[child]:
                        labels[child][p_label] = labels[parent][p_label] + binarytreeG[parent][child]
    return labels
